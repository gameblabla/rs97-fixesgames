  ...
  if (use_fullscreen)
    {
      ...
      ScreenSurface = SDL_SetVideoMode(SCREEN_W, 480/*SCREEN_H*/, 0, SDL_HWSURFACE |  SDL_DOUBLEBUF);
      screen = SDL_CreateRGBSurface(SDL_HWSURFACE, SCREEN_W, SCREEN_H, 16, 0, 0, 0, 0);
      SDL_ShowCursor(0);
#endif
      if (screen == NULL)
        {
...
#else
      //screen = SDL_SetVideoMode(SCREEN_W, SCREEN_H, 16, SDL_HWSURFACE |  SDL_DOUBLEBUF ) ;
      ScreenSurface = SDL_SetVideoMode(SCREEN_W, 480/*SCREEN_H*/, 16, SDL_HWSURFACE |  SDL_DOUBLEBUF);
      screen = SDL_CreateRGBSurface(SDL_HWSURFACE, SCREEN_W, SCREEN_H, 16, 0, 0, 0, 0);
#endif
      if (screen == NULL)
        {
