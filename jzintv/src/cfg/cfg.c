...
#endif
{
    ...
    cfg->fn_exec    = strdup("bios/exec.bin");   /* Default name to look for     */
    cfg->fn_grom    = strdup("bios/grom.bin");   /* ...                          */
    cfg->fn_game    = strdup("bios/game.rom");   /* ...                          */
    cfg->fn_ecs     = strdup("bios/ecs.bin");    /* ...                          */
#else
