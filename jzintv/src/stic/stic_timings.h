...
#define PAL_INTRQ_HOLD          (2907 + PAL_FRAMDIFF)                     
#define PAL_BUSRQ_HOLD_FIRST    (80)    /* First BUSRQ is really short?     */
#define PAL_BUSRQ_HOLD_NORMAL   (115)   /* Typical BUSRQs during display    */
#define PAL_BUSRQ_HOLD_EXTRA    (80)    /* 14th BUSRQ is half-length        */
#define PAL_MUST_BUSAK_TIME     (75)    /* CPU must ACK a BUSRQ by here     */
