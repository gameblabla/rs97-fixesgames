...
typedef struct event_t
{
    ...
    uint_32     do_menu;        /* Display menu                             */
    uint_32     do_vkbd;        /* Display virtual numberpad                */
    uint_32     do_vkbd_up;     /* Move selected button                     */
    uint_32     do_vkbd_down;   /* Move selected button                     */
    uint_32     do_vkbd_left;   /* Move selected button                     */
    uint_32     do_vkbd_right;  /* Move selected button                     */
    uint_32     do_vkbd_select; /* Select highlighted button                */
#endif
