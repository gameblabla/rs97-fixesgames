...
This test is almost identical to "mem_test", only it adds the twist
that it relies on Intellicart bank switching to test most of the
Intellicart's memory map.
