...
//    screen = SDL_SetVideoMode(reswidth, resheight, bitdepth, SDL_SWSURFACE); //dingoo version
    ScreenSurface = SDL_SetVideoMode(320, 480, 16, SDL_HWSURFACE | SDL_DOUBLEBUF);  //gcw version
